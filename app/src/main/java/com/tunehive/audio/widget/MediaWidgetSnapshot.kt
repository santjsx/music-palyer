 ...
 * connecting one means starting [PlaybackService][com.tunehive.audio.playback.PlaybackService]
 * just to find out what to draw. So the service writes here whenever the answer
 * changes ([publishWidgetState][com.tunehive.audio.playback.PlaybackService]) and
...
internal data class MediaWidgetSnapshot(
    ...
    companion object {
         ...
         * process by
         * [BitChordApplication.onCreate][com.tunehive.audio.BitChordApplication],
