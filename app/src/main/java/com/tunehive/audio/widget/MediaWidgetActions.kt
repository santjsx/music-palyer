...
import com.tunehive.audio.playback.PlaybackService
 ...
 * from [rememberMediaController][com.tunehive.audio.playback.rememberMediaController].
 *
...
class MediaWidgetActions : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_TOGGLE = "com.tunehive.audio.widget.TOGGLE"
        const val ACTION_NEXT = "com.tunehive.audio.widget.NEXT"
        const val ACTION_PREVIOUS = "com.tunehive.audio.widget.PREVIOUS"
