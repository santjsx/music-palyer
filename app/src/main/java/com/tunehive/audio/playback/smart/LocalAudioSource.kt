package com.tunehive.audio.playback.smart
 ...
 * [com.tunehive.audio.playback.AudioCache], because that is where *streamed*
 * audio lands. A track playing off the device never goes there:
 * [com.tunehive.audio.playback.AudioCache.playbackFactory] routes `file://` and
 ...
 * [com.tunehive.audio.playback.AudioCache.requestAnalysisHead] — the fallback
