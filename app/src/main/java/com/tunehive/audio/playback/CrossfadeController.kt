...
import com.tunehive.audio.data.settings.SmartAnalysis
import com.tunehive.audio.data.settings.TrackAnalysisState
import com.tunehive.audio.data.settings.TransitionWindow
import com.tunehive.audio.playback.smart.CrossfadeMode
import com.tunehive.audio.playback.smart.TrackAnalysis
import com.tunehive.audio.playback.smart.TransitionStyle
import com.tunehive.audio.playback.smart.TransitionTrackInfo
import com.tunehive.audio.playback.smart.planTransition
...
class CrossfadeController(
     ...
     * makes a plan's
     * [com.tunehive.audio.playback.smart.TransitionPlan.transitionStyle] audible
    ...
    /**
     * The style fields of a [com.tunehive.audio.playback.smart.TransitionPlan],
     ...
     * ([com.tunehive.audio.playback.smart.TransitionPlan.incomingCueTime]),
     * and the tempo-stretch to align it with the outgoing track
     * ([com.tunehive.audio.playback.smart.TransitionPlan.incomingPlaybackRate])
     * — see [driveLap], which applies both at the handoff — and the style the
     * blend is rendered in
     * ([com.tunehive.audio.playback.smart.TransitionPlan.transitionStyle]),
     ...
     * [com.tunehive.audio.playback.smart.TrackAnalyzer.request] as the next
