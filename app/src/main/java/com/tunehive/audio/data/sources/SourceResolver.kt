package com.tunehive.audio.data.sources
...
import com.tunehive.audio.data.settings.DownloadQuality
...
object SourceResolver {
     ...
     * [toMediaItem][com.tunehive.audio.playback.toMediaItem].
     */
     ...
     * [StreamChoice][com.tunehive.audio.playback.StreamChoice] before caching a
     ...
     * plays lossy for the rest of its length, because [QualityUpgrade][com.tunehive.audio.playback.QualityUpgrade]
     ...
     * directly — see
     * [resolveForDownload][com.tunehive.audio.data.innertube.StreamResolver.resolveForDownload]
     ...
     *
     * [DownloadQuality.LOSSLESS][com.tunehive.audio.data.settings.DownloadQuality.LOSSLESS]
     * and [DownloadQuality.HIGH][com.tunehive.audio.data.settings.DownloadQuality.HIGH];
     * not [DownloadQuality.STANDARD][com.tunehive.audio.data.settings.DownloadQuality.STANDARD].
     ...
     * the live lookup [QualityUpgrade][com.tunehive.audio.playback.QualityUpgrade]
     ...
     * [AudioCache][com.tunehive.audio.playback.AudioCache] decide how to treat
     ...
     * [PlaybackService][com.tunehive.audio.playback.PlaybackService]'s
