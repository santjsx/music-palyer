package com.tunehive.audio.data.model
...
data class Song(
     ...
     * that need it — see [com.tunehive.audio.playback.toMediaItem].
     */
...
data class DetailPage(
     ...
     * added — see [com.tunehive.audio.data.innertube.InnertubeParser.parsePlaylistShelf].
