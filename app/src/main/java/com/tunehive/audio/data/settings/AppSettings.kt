package com.tunehive.audio.data.settings
 ...
 * [StreamResolver.resolveForDownload][com.tunehive.audio.data.innertube.StreamResolver.resolveForDownload]),
...
object AppSettings {
    ...
    // [SourceResolver.requestForNow][com.tunehive.audio.data.sources.SourceResolver.requestForNow],
     ...
     * decode per track.
     *
     * See [com.tunehive.audio.playback.smart.TransitionPlanner].
     */
    val smartFadeEnabled = MutableStateFlow(false)
    val skipSilence = MutableStateFlow(false)

    /**
     * Widens stereo output via [com.tunehive.audio.playback.SpatialAudioProcessor],
     ...
     * [YtMusicRepository.resolveAudio][com.tunehive.audio.data.YtMusicRepository.resolveAudio],
     ...
     * all. See [CanvasRepository][com.tunehive.audio.data.canvas.CanvasRepository].
     */
     ...
     * — see [CanvasCache][com.tunehive.audio.data.canvas.CanvasCache] for why
     ...
     * [NowPlayingScreen][com.tunehive.audio.ui.player.NowPlayingScreen].
     */
    ...
    /**
     * The order [lyricsSources] are asked in — see [LyricsRepository][com.tunehive.audio.data.lyrics.LyricsRepository]:
    ...
    /** Disk budget for cached audio. [AudioCache][com.tunehive.audio.playback.AudioCache] evicts past it. */
     ...
     * [ArtistFacts][com.tunehive.audio.data.stats.ArtistFacts]. On by default,
     ...
     * [PlaybackService][com.tunehive.audio.playback.PlaybackService] can pick
     ...
     *
     * The one caller is an import ([Backup][com.tunehive.audio.data.stats.Backup]),
     ...
     *
     * BitChord ships sideloaded (see [com.tunehive.audio.data.AppUpdateChecker]),
     ...
     *
     * [Downloads][com.tunehive.audio.download.Downloads] keeps its record of
