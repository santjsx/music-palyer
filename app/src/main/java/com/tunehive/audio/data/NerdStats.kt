...
object NerdStats {
     ...
     * [QualityUpgrade.adoptUnresolved][com.tunehive.audio.playback.QualityUpgrade.adoptUnresolved].
    ...
    fun declaredFormat(mediaId: String?): StreamFormat? {
        ...
        return declared[key]
            ?: com.tunehive.audio.data.sources.SourceRegistry.parseTrackKey(key)
     ...
     * [PlaybackService][com.tunehive.audio.playback.PlaybackService] — which the
     ...
     *
     * @see com.tunehive.audio.playback.QualityUpgrade.forgetLastSession for the
