 ...
 * [StreamResolver][com.tunehive.audio.data.innertube.StreamResolver]. Sources
...
data class SourceStream(
     ...
     * [QualityUpgrade][com.tunehive.audio.playback.QualityUpgrade].
     */
     ...
     * see [QualityUpgrade][com.tunehive.audio.playback.QualityUpgrade.lookAgain].
 ...
 * [AppSettings][com.tunehive.audio.data.settings.AppSettings] and is turned
