package com.tunehive.audio.data.canvas
 ...
 * [CanvasArtworkPlayer][com.tunehive.audio.ui.player.CanvasArtworkPlayer].
 *
...
object CanvasCache {
    ...
    /** Opened once per process, alongside [com.tunehive.audio.playback.AudioCache.init]. */
     ...
     * choice [com.tunehive.audio.playback.AudioCache] makes for audio.
     */
