 ...
 * `next`-endpoint fetches, [ChunkedDataSource][com.tunehive.audio.playback.ChunkedDataSource]
 * and [AudioCache][com.tunehive.audio.playback.AudioCache]'s multi-megabyte
