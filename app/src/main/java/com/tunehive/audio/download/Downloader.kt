 ...
 *    the same finding [ChunkedDataSource][com.tunehive.audio.playback.ChunkedDataSource]
 *    exists for.
...
object Downloader {
     ...
     *    URL — see [SourceStream.headers][com.tunehive.audio.data.sources.SourceStream.headers]
