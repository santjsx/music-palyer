...
import com.tunehive.audio.data.lyrics.WORD_LYRICS_FIELD
...
object Mp4Tagger {
     ...
     * file — see [EmbeddedLyrics][com.tunehive.audio.data.lyrics.EmbeddedLyrics],
    ...
    private const val MEAN = "com.tunehive.audio"
